							...
							if ($action == 'result') {
								...
								if (@$response['error'] == 'ok') {
									...
									if (@$response['message']) {
										...
										echo '<h3 class="text-danger mb-3">error</h3>';
									}
								...
								<form action="?action=result" method="post" class="information-form-area mb--20">
									...
									<div class="info-item">
										...
										<div class="row">
											<div class="information-form-group col-sm-12">
												<div class="form-check form-check-inline">
													<input class="form-check-input" type="radio" name="db_type"
														value="existing-database" id="existing-database" checked>
													<label for="existing-database">Existing Database </label>
												</div>
												<!--
												<div class="form-check form-check-inline">
													<input class="form-check-input" type="radio" name="db_type"
														value="create-new-database" id="create-new-database">
											...
											<div class="information-form-group col-sm-6">
												<input class="secure-password" type="text" name="db_pass"
													placeholder="Database Password">
												<small class="d-none text-danger weak-password-error"> Week password
													detected</small>
											</div>
										</div>
									</div>
	...
	<footer class="py-3 text-center bg--dark border-top border-primary">
		<div class="container">
			<p class="m-0 font-weight-bold">&copy;<?php echo Date('Y') ?> - All Right Reserved by <a
					href="https://viserlab.com/">ViserLab LLC</a></p>
		</div>
		<?php echo $action; ?>
	</footer>
